...
# Step 5: Define the Logistic Regression model with increased max_iter
...
plt.savefig(r"C:/Users/User/Desktop/10Acadamy/Week 6/code/cm_Logistic_Regression.jpg")
plt.show()
...
ax.bar(x, metric_values, width, label='Logistic Regression')
...
output_plot_path = r"C:\Users\User\Desktop\10Acadamy\Week 6\code\logistic_regression_evaluation_metrics.jpg"
plt.tight_layout()
plt.savefig(output_plot_path)
plt.show()

# Save the results to a CSV file in the specified local folder
output_results_path = r"C:\Users\User\Desktop\10Acadamy\Week 6\code\logistic_regression_results.csv"
...
print("Logistic Regression model evaluation metrics and results saved successfully.")
